...
hoistedDependencies:
  ...
  examples/01-basic-boundary:
    01-basic-boundary: private
  examples/02-global-app-boundary:
    02-global-app-boundary: private
  examples/03-sentry-integration:
    03-sentry-integration: private
  expect-type@1.3.0:
    expect-type: private
  fast-glob@3.3.3:
    fast-glob: private
  ...
  tsup@8.5.1(jiti@1.21.7)(postcss@8.5.8)(typescript@5.9.3):
    tsup: private
  typescript@5.9.3:
    typescript: private
  ufo@1.6.3:
...
pendingBuilds: []
prunedAt: Sun, 08 Mar 2026 05:22:38 GMT
publicHoistPattern:
  - '*eslint*'
  - '*prettier*'
registries:
...
skipped:
  ...
  - '@rollup/rollup-win32-x64-gnu@4.59.0'
  - '@rollup/rollup-win32-x64-msvc@4.59.0'
storeDir: /Users/admin/Projects/personal/react-error-boundary-patterns/.pnpm-store/v3
